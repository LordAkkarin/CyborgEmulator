 ...
 */
public class MemoryAccessViolationException extends MemoryException {

	/**
	 * Constructs a new MemoryAccessViolationException instance.
	 */
	 ...
	 * @param cause The error cause.
	 */
	public MemoryAccessViolationException (Throwable cause) {
		super (cause);
	}
}