...
/**
 * 0x8XY7: Sets register X to register Y minus register X.
 * @author Johannes Donath <johannesd@evil-co.com>
 * @copyright Copyright (C) 2014 Evil-Co <http://www.evil-co.com>
 */
@Opcode (0x8007)
public class SubtractOpcode implements IOpcode<Chip8Emulator> {
	...
	public boolean execute (Chip8Emulator emulator, long opcode) throws OpcodeException {
		...
		try {
			...
			short value = ((short) (valueB - valueA));

			emulator.getProcessor ().getRegister ().set (0xF, ((short) (value >= 0x00 ? 1 : 0)));
