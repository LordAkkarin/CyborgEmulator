...
/**
 * 0x7XNN: Adds NN to the value of register X.
 * @author Johannes Donath <johannesd@evil-co.com>
 * @copyright Copyright (C) 2014 Evil-Co <http://www.evil-co.com>
 */
@Opcode (0x7000)
public class AddRegisterValueOpcode implements IOpcode<Chip8Emulator> {
	...
	public boolean execute (Chip8Emulator emulator, long opcode) throws OpcodeException {
		...
		try {
			emulator.getProcessor ().getRegister ().set (register, ((short) (emulator.getProcessor ().getRegister ().get (register) + value)));
