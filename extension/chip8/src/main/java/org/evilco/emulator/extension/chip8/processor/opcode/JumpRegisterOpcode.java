...
/**
 * 0xBNNN: Jumps to address NNN plus the value of register 0x0.
 * @author Johannes Donath <johannesd@evil-co.com>
 * @copyright Copyright (C) 2014 Evil-Co <http://www.evil-co.com>
 */
@Opcode (0xB000)
public class JumpRegisterOpcode implements IOpcode<Chip8Emulator> {
	...
	public boolean execute (Chip8Emulator emulator, long opcode) throws OpcodeException {
		int value = ((int) (opcode & 0x0FFF));

		try {
			value += emulator.getProcessor ().getRegister ().get (0x0);
			emulator.getProcessor ().setPointer (value);
