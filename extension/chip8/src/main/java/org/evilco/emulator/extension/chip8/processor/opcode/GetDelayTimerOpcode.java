...
/**
 * 0xFX15: Sets register X to the current delay timer value.
 * @author Johannes Donath <johannesd@evil-co.com>
 * @copyright Copyright (C) 2014 Evil-Co <http://www.evil-co.com>
 */
@Opcode (0xF007)
public class GetDelayTimerOpcode implements IOpcode<Chip8Emulator> {
	...
	public boolean execute (Chip8Emulator emulator, long opcode) throws OpcodeException {
		short address = ((short) ((opcode & 0x0F00) >> 8));

		try {
			emulator.getProcessor ().getRegister ().set (address, emulator.getProcessor ().getDelayTimer ());
