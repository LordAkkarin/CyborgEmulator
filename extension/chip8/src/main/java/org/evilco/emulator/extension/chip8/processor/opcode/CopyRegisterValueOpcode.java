...
/**
 * 0x8XY0: Copies the value of register Y to register X
 * @author Johannes Donath <johannesd@evil-co.com>
 * @copyright Copyright (C) 2014 Evil-Co <http://www.evil-co.com>
 */
@Opcode (0x8000)
public class CopyRegisterValueOpcode implements IOpcode<Chip8Emulator> {
	...
	public boolean execute (Chip8Emulator emulator, long opcode) throws OpcodeException {
		...
		try {
			emulator.getProcessor ().getRegister ().set (registerA, emulator.getProcessor ().getRegister ().get (registerB));
