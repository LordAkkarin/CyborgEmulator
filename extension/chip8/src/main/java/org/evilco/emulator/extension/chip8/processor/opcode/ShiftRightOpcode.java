...
/**
 * 0x8X06: Shifts the value of register X to the right by one and stores the least significant bit in register 0xF.
 * @author Johannes Donath <johannesd@evil-co.com>
 * @copyright Copyright (C) 2014 Evil-Co <http://www.evil-co.com>
 */
@Opcode (0x8006)
public class ShiftRightOpcode implements IOpcode<Chip8Emulator> {
	...
	public boolean execute (Chip8Emulator emulator, long opcode) throws OpcodeException {
		...
		try {
			...
			emulator.getProcessor ().getRegister ().set (0xF, ((short) (value & 0x1)));
