...
/**
 * 2NNN: Calls a subroutine at address NNN.
 * @author Johannes Donath <johannesd@evil-co.com>
 * @copyright Copyright (C) 2014 Evil-Co <http://www.evil-co.com>
 */
@Opcode (0x2000)
public class CallOpcode implements IOpcode<Chip8Emulator> {
	...
	public boolean execute (Chip8Emulator emulator, long opcode) throws OpcodeException {
		...
		// update call stack
		emulator.getProcessor ().getStack ().push (emulator.getProcessor ().getPointer ());
