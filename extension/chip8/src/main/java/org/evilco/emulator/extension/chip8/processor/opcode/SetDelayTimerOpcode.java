...
/**
 * 0xFX15: Sets the delay timer to the value of register X.
 * @author Johannes Donath <johannesd@evil-co.com>
 * @copyright Copyright (C) 2014 Evil-Co <http://www.evil-co.com>
 */
@Opcode (0xF015)
public class SetDelayTimerOpcode implements IOpcode<Chip8Emulator> {
	...
	public boolean execute (Chip8Emulator emulator, long opcode) throws OpcodeException {
		...
		try {
			emulator.getProcessor ().setDelayTimer (emulator.getProcessor ().getRegister ().get (register));
