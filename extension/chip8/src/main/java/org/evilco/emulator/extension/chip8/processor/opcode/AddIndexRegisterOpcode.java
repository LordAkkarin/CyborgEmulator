...
/**
 * 0xFX1E: Adds the value stored in register X to the index register.
 * @author Johannes Donath <johannesd@evil-co.com>
 * @copyright Copyright (C) 2014 Evil-Co <http://www.evil-co.com>
 */
@Opcode (0xF01E)
public class AddIndexRegisterOpcode implements IOpcode<Chip8Emulator> {
	...
	public boolean execute (Chip8Emulator emulator, long opcode) throws OpcodeException {
		...
		try {
			int value = emulator.getProcessor ().getIndexRegister ();
			value += emulator.getProcessor ().getRegister ().get (register);
