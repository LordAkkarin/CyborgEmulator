...
/**
 * 0xFX29: Copies the sprite location of the character stored in register X into the index register.
 * @author Johannes Donath <johannesd@evil-co.com>
 * @copyright Copyright (C) 2014 Evil-Co <http://www.evil-co.com>
 */
@Opcode (0xF029)
public class CopySpriteLocationOpcode implements IOpcode<Chip8Emulator> {
	...
	public boolean execute (Chip8Emulator emulator, long opcode) throws OpcodeException {
		...
		try {
			int value = (emulator.getProcessor ().getRegister ().get (register) * 0x5);
