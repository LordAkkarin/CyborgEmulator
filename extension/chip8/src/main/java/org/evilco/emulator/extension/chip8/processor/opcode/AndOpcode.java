...
/**
 * 0x8XY2: Sets the value of register X to register X AND register Y.
 * @author Johannes Donath <johannesd@evil-co.com>
 * @copyright Copyright (C) 2014 Evil-Co <http://www.evil-co.com>
 */
@Opcode (0x8002)
public class AndOpcode implements IOpcode<Chip8Emulator> {
	...
	public boolean execute (Chip8Emulator emulator, long opcode) throws OpcodeException {
		...
		try {
			...
			emulator.getProcessor ().getRegister ().set (registerA, ((short) (valueA & valueB)));
